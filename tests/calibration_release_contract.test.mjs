...
assert.equal(manifest.research_boundary.purpose, 'MECHANICAL_TIMING_CALIBRATION_WITH_PRODUCT_SHAPED_LOCAL_FLOW');
assert.equal(manifest.research_boundary.gate_d, 'NONE');
assert.equal(manifest.research_boundary.gate_e, 'NONE');
assert.equal(manifest.research_boundary.participant_result, 'FAIL_CLOSED_NOT_ESTIMABLE');
...
assert.equal(manifest.research_boundary.reason_response_latency_upload, false);
assert.equal(manifest.research_boundary.intensity_upload, false);
assert.equal(manifest.research_boundary.intensity_response_latency_upload, false);
